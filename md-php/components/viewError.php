...
<body>
  <section class="relative w-full">
    <form action="" method="POST" class="absolute top-64 left-[25%] right-[25%] text-center text-3xl font-semibold  bg-white text-[#0123E7] border-2 border-[#0123E7] py-8 px-2">
      <h2>No hay stock de los productos o no se encuentra el producto seleccionado, ¿Desea reservar otro pedido?</h2>
      <div class="flex justify-center items-center gap-4 my-6">
        <input class="bg-[#0123E7] px-4 py-2 text-base text-white rounded-lg hover:scale-[0.9]" type="submit" name="error" value="Volver">
      </div>
    </form>
